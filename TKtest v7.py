...
def HELL2():
    ClearWindow()
    Tr = Button(wraplength=100, justify=LEFT, text = ":trollface::trollface: :trollface::trollface::trollface: :trollface::trollface::trollface:::trollface::trollface:::trollface::trollface:: :trollface:  :trollface: :trollface::trollface::trollface::trollface:::trollface::trollface:: :trollface::trollface::trollface:: :trollface::trollface::trollface:::trollface::trollface:::trollface::trollface:: :trollface: :trollface: :trollface:  :trollface:  :trollface:  :trollface:  :trollface: :trollface: :trollface: :trollface:  :trollface: :trollface:  :trollface:", color = "#abb06b")
    Tr.grid(column = 0, row = 1)
...
def EE():
    ...
    def TROLL2():
        ...
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 0, row = 2)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 0, row = 3)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 0, row = 4)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 0, row = 5)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 0, row = 6)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 0, row = 7)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 0, row = 8)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 0, row = 9)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 0, row = 10)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 0, row = 11)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 0, row = 12)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 0, row = 13)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 1, row = 2)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 1, row = 3)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 1, row = 4)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 1, row = 5)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 1, row = 6)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 1, row = 7)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 1, row = 8)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 1, row = 9)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 1, row = 10)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 1, row = 11)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 1, row = 12)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 1, row = 13)
            
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 2, row = 2)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 2, row = 3)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 2, row = 4)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 2, row = 5)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 2, row = 6)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 2, row = 7)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 2, row = 8)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 2, row = 9)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 2, row = 10)
        
        Ba1Main = Button(text = "Give up", bg = 'red', command = no)
        Ba1Main.grid(column = 2, row = 11)
        
        Ba2Main = Button(text = "Give up", bg = 'red', command = no)
        Ba2Main.grid(column = 2, row = 12)
        
        Ba3Main = Button(text = "Give up", bg = 'red', command = no)
        Ba3Main.grid(column = 2, row = 13)


    def no():
        ClearWindow()
        
        Ba3Main = Button(text = "You should have never come here", bg = 'red', cursor = "coffee_mug", command = crash)
        Ba3Main.grid(column = 0, row = 1)

        Ba3Main = Button(text = "there is no returning", bg = 'red', cursor = "boat",  command = crash)
        Ba3Main.grid(column = 0, row = 2)

        Ba3Main = Button(text = "you will be destroyed", bg = 'red', cursor = "spider", command = crash)
        Ba3Main.grid(column = 0, row = 3)

        Ba3Main = Button(text = "to escape you must answer this riddle", bg = 'red', cursor = "trek", command = leave)
        Ba3Main.grid(column = 0, row = 4)

        Ba3Main = Button(text = "It travles thru the universe seeking something it finds everyday yet its journy takes years.", bg = 'red')
        Ba3Main.grid(column = 0, row = 5)

        Ba3Main = Button(text = "a mistake could be the last one you make", bg = 'red', cursor = "watch", command = crash)
    ...
    def leave():
        ...
        BBBBB = Button(text = "leave, actually, no tricks, jsut leave", command = exit)
        BBBBB.grid(column = 1, row = 1)


    def exit():
        sys.exit("you have left")
